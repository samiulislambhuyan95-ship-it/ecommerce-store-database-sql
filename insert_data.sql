...
('Vivek Shah', 'vivek@gmail.com', 'Mumbai', '2025-01-17'),
('Manoj Joshi', 'manoj@gmail.com', 'Vadodara', '2025-01-18'),
('Isha Kapoor', 'isha@gmail.com', 'Gurgaon', '2025-01-19'),
('Arjun Das', 'arjun@gmail.com', 'Hyderabad', '2025-01-20');
-- PRODUCTS
INSERT INTO products (product_name, category, price, stock) VALUES
('Code Hoodie', 'Clothing', 1999, 50),
('Dev Hoodie', 'Clothing', 1899, 40),
('Debugging Mug', 'Accessories', 599, 100),
('Code Coffee Mug', 'Accessories', 549, 80),
('DSA Notebook', 'Stationery', 499, 150),
('SQL Notes', 'Stationery', 299, 200),
...
('Classic Hoodie', 'Clothing', 2099, 35),
...
('Dark Night Hoodie', 'Clothing', 2199, 30),
...
-- Added data
(4, 'Debit Card', 1899, '2025-02-04'),

(5, 'Debit Card', 897, '2025-02-05'),

-- Added data
(6, 'UPI', 549, '2025-02-06'),
...
-- Added data
(10, 'Credit Card', 799, '2025-02-10'),

(11, 'UPI', 2099, '2025-02-11'),
(12, 'Debit Card', 699, '2025-02-12'),

-- Added data
(13, 'UPI', 1098, '2025-02-13'),
